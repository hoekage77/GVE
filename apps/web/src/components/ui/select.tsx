...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        "gve-select-content",
        "relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border border-black/10 bg-card text-card-foreground shadow-lg",
        position === "popper" &&
