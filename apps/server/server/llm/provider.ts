...
export function resolveProviders(): ResolvedProvider[] {
  return PROVIDER_DEFINITIONS
    .map((definition): ResolvedProvider => {
 ...
 */
export function resolveEnabledProviders(): ResolvedProvider[] {
 ...
 */
export function getProviderById(id: string): ResolvedProvider | null {
 ...
 */
export function getThinkingProviders(): ResolvedProvider[] {
 ...
 */
export function getCodeGenerationProviders(): ResolvedProvider[] {
